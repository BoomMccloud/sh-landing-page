...
export default function CaseStudyPageLayout({ content }: CaseStudyPageLayoutProps) {
  // Basic check if content exists, though should always be provided by parent page
  if (!content) {
    // In a real app, you might want a more robust fallback or error display
    return <div>Case study data is missing.</div>
  }

  return (
    <div>
      {/* Back Button - Links to root, assuming case studies are linked from the homepage */}
      <Link
        href="/#case-studies"
